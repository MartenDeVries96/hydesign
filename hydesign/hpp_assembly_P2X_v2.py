...
from hydesign.ems_v2 import ems_P2X, ems_long_term_operation
from hydesign.battery_degradation import battery_degradation
from hydesign.costs_v2 import wpp_cost, pvp_cost, battery_cost, shared_cost, ptg_cost
from hydesign.finance_v2 import finance_P2X
...
class hpp_model_P2X:
    ...
    def __init__(
        ...
        **kwargs
        ...
        prob.set_val('m_H2_demand_t', weather['H2_demand'])
