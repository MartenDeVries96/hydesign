...
from hydesign.hpp_assembly_P2X_v2 import hpp_model_P2X
from hydesign.examples import examples_filepath
from hydesign.EGO_surrogate_based_optimization_P2X import (get_sm, eval_sm,
...
class EfficientGlobalOptimizationDriver(Driver):
    ...
    def run(self):
        ...
        hpp_m = self.hpp_model_P2X(**kwargs)
...
if __name__ == '__main__':
    ...
    kwargs['xtypes'] = [
        ...
        #b_P, b_E_h , cost_of_battery_P_fluct_in_peak_price_ratio, ptg_MW, HSS_kg
