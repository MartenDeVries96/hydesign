...
def ems_cplex_P2X(
    ...
    for ib, batch in enumerate(batches):
        ...
        E_SOC_ts_batch, m_H2_ts_batch, m_H2_offtake_ts_batch, m_H2_storage_ts_batch, m_H2_grid_ts_batch, P_ptg_grid_ts_batch, LoS_H2_ts_batch, penalty_batch = ems_cplex_parts_P2X(
            wind_ts = wind_ts_sel,
            solar_ts = solar_ts_sel,
            price_ts = price_ts_sel,
            P_batt_MW = P_batt_MW,
